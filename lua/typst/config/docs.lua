...
local optional_nil_defaults = config_spec.doc_nil_defaults
local optional_types = config_spec.doc_optional_types
local type_overrides = config_spec.doc_type_overrides
